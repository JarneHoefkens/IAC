            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span style="padding-left: 224px;">Copyright &copy; CCS06 Hosting 2021</span><br></br>
                        <span style="padding-left: 224px;"><a href="./responsibledisclosure.php">Responsible disclosure</a>&nbsp;&nbsp;&nbsp;<a href="./walloffame.php">Hacker Hall of Fame</a</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->       
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Voornaam: <?php echo ucfirst($firstnamesession); ?></br>
                    Achternaam: <?php echo ucfirst($lastnamesession); ?></p>
