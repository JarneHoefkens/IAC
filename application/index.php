...
?>
    ...
    <div class="container-fluid">
        ...
        <ol>
            <li>Ga via je FTP software naar je mapje op de server. Je kan deze <a href="ftps://172.26.6.100"><b>link</b></a> gebruiken om rechtstreeks naar de server te gaan.<br>
            ...
            <li>Indien je webapp een database gebruikt, kan je deze in orde brengen via deze <a href="http://172.26.6.100/phpmyadmin/" target="_blank"><b>link</b></a>.
            ...
            <li>Je kan je website terugvinden via volgende link: <a href="http://<?php echo $username['username'];?>.hostingccs06.tech" target="_blank"><b><?php echo $username['username'];?>.hostingccs06.tech</b></a>.</li>
        </ol>
        ...
        <p>Indien je PHP applicatie gebruik maakt van Laravel kan je naar de <a href="laravel.php">"<b>Laravel</b>"</a> pagina gaan.<br> 
